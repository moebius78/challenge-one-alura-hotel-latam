...
public class Login extends JFrame {
	...
	public Login() {
		...
		lblAdmin.setBounds(488, 156, 45, 13);
		contentPane.add(lblAdmin);
		
		JLabel lblHotelalura = new JLabel("admin");
		lblHotelalura.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblHotelalura.setBounds(500, 230, 94, 26);
		contentPane.add(lblHotelalura);
...
private boolean validarUsuario(String nombre, String clave) {
	...
	JOptionPane.showMessageDialog(this, "Datos Incorrectos, Por favor intente nuevamente");
		return false;
	}
}
