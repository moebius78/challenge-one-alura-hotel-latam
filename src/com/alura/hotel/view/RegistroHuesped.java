...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		txtNombre.addKeyListener(new java.awt.event.KeyAdapter() {
	        public void keyTyped(java.awt.event.KeyEvent evt) {
	            ...
	            if((!(Character.isLetter(evt.getKeyChar())) && (((evt.getKeyChar() != KeyEvent.VK_SPACE)) && ((evt.getKeyChar() != KeyEvent.VK_BACK_SPACE))))){
	                   evt.consume();
	                   JOptionPane.showMessageDialog(contentPane, "Ingrese solo letras");
	               }
	           }
	       });
		...
		btnGuardar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(txtNombre.getText() =="" || txtApellido.getText() =="" || txtTelefono.getText() =="" || txtFechaN.getDate() == null) {
					JOptionPane.showMessageDialog(contentPane, "Debe completar todos los campos");
				}else {
					guardar();
		...
		txtTelefono.addKeyListener(new java.awt.event.KeyAdapter() {
	        public void keyTyped(java.awt.event.KeyEvent evt) {
	            ...
	            if(!(Character.isDigit(evt.getKeyChar())) && (evt.getKeyChar() != KeyEvent.VK_BACK_SPACE)){
	                   evt.consume();
	                   JOptionPane.showMessageDialog(contentPane, "Solamente numeros");
	               }
	           }
	       });
		...
		ReservaDAO reservaDAO = new ReservaDAO(factory.recuperaConexion());
		txtNreserva.setText("" + (reservaDAO.obtenerIdReserva()+1));
	}
	...
	private void guardar() {
			...
			var factory = new ConnectionFactory();
			ReservaDAO reservaDAO = new ReservaDAO(factory.recuperaConexion());
			txtNreserva.setText("" + reservaDAO.obtenerIdReserva());
			Huesped huesped = new Huesped(nombre, apellido, fechaN, nacionalidad, telefono,reservaDAO.obtenerIdReserva());
